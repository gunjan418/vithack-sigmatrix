...
if("TRUE" STREQUAL "TRUE")
  set(hlpr_speech_synthesis_SOURCE_PREFIX /home/gunjan/Desktop/VITHack/vithack-sigmatix/Movel-AI/catkin_ws/src/speech/hlpr_speech/hlpr_speech_synthesis)
  set(hlpr_speech_synthesis_DEVEL_PREFIX /home/gunjan/Desktop/VITHack/vithack-sigmatix/Movel-AI/catkin_ws/devel)
  ...
  set(hlpr_speech_synthesis_INSTALL_PREFIX /home/gunjan/Desktop/VITHack/vithack-sigmatix/Movel-AI/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hlpr_speech_synthesis' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'hlpr_speech_synthesis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gunjan/Desktop/VITHack/vithack-sigmatix/Movel-AI/catkin_ws/src/speech/hlpr_speech/hlpr_speech_synthesis/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hlpr_speech_synthesis_NUM_DUMMY_TARGETS)
      set(hlpr_speech_synthesis_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hlpr_speech_synthesis::wrapped-linker-option${hlpr_speech_synthesis_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hlpr_speech_synthesis_NUM_DUMMY_TARGETS "${hlpr_speech_synthesis_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hlpr_speech_synthesis::wrapped-linker-option${hlpr_speech_synthesis_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hlpr_speech_synthesis_LIBRARIES "${interface_target_name}")
