...
SWIGINTERN PyObject *_wrap_new_Decoder__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  Decoder *result = 0 ;
...
SWIGINTERN PyObject *_wrap_new_Decoder__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
